...
import { LoginPage, HomePage, NewsPage, NewsDetail, UnitsPage, WordsPage, WordSlides, PlaylistsPage, PlaylistDetail, FeedbackPage, SettingPage, PlaygroundPage, TabHomePage, TabUserPage,  ModalDownloadPage, MultipleChoiceSlides, MatchingWords, LearningSlides, AboutUsPage, SentencePage, AuthorInfo, TabNewsContent, TabNewsPhrases } from '../pages';
...
import { CustomDatePipe, CustomTimePipe, CommaConcatPipe } from '../pipes';
...
@NgModule({
  declarations: [
    MyApp,
    LoginPage, HomePage, NewsPage, NewsDetail, UnitsPage, WordsPage, WordSlides, PlaylistsPage, PlaylistDetail, FeedbackPage, SettingPage, PlaygroundPage, TabHomePage, TabUserPage, ModalDownloadPage, MultipleChoiceSlides, MatchingWords, LearningSlides, AboutUsPage, SentencePage, TabNewsContent, TabNewsPhrases,
    ...
    CustomDatePipe, CustomTimePipe, CommaConcatPipe
  ],
  imports: [
  ...
  entryComponents: [
    MyApp,
    LoginPage, HomePage, NewsPage, NewsDetail, UnitsPage, WordsPage, PlaylistOptions, SelectedWords, WordSlides, PlaylistsPage, PlaylistDetail, FeedbackPage, SettingPage, PlaygroundPage, TabHomePage, TabUserPage, ModalDownloadPage, MultipleChoiceSlides, MatchingWords, LearningSlides, AboutUsPage, SentencePage, SettingWord, AuthorInfo, TabNewsContent, TabNewsPhrases
  ],
  providers: [
    {
